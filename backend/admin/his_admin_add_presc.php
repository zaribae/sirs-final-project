                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="10">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th data-hide="phone">Patient's ID</th>
                                                <th data-hide="phone">Patient's Gender</th>
                                                <th data-hide="phone">Patient's Age</th>
                                                <th data-hide="phone">Patient's Diagnosis</th>
                                        ...
                                        /*
                                                ...
                                                *
                                            */
                                        $ret = "SELECT * FROM  his_patients ORDER BY pat_id ";
                                        ...
                                        ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->pat_diagnosis; ?></td>

                                                    <td><a href="his_admin_add_single_pres.php?pat_number=<?php echo $row->pat_number; ?>" class="badge badge-success"><i class="fas fa-highlighter "></i>
