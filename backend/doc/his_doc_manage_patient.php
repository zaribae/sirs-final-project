                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="10">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Patient's ID</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->pat_id; ?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a>
