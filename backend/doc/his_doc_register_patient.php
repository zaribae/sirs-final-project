...
if (isset($_POST['add_patient'])) {
    ...
    $query = "insert into his_patients (pat_age, pat_gender, pat_id, pat_diagnosis) values(?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('ssis', $pat_age, $pat_gender, $pat_id, $pat_diagnosis);
    $stmt->execute();
    /*
                                    ...
                                    <form method="post">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" required="required" name="pat_id" class="form-control" id="inputEmail4" placeholder="Patient's ID">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required="required" class="form-control" name="pat_diagnosis" id="inputAddress" rows="7"></textarea>
